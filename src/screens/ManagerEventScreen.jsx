...
import { GetCaseSingle, GetLookupValues, UpdateCase } from '../data/cases'
...
const ManagerEventScreen = () => {
    ...
    // const [emergencyServiceDetails, setEmergencyServiceDetails] = useState("")

    const navigate = useNavigate();

    const witnessTypesList = [
        { id: "1", title: "No Witness" },
        { id: "2", title: "Employee" },
        { id: "3", title: "Customer" },
    ] 
    ...
    const emergencyServicesList = [
        { id: "1", title: "No" },
        { id: "2", title: "Affected person taken to A&E by employee" },
        { id: "3", title: "Ambulance Service" },
        { id: "4", title: "Fire Brigade" },
        { id: "5", title: "Police" },
        { id: "6", title: "Coastguard" },
    ]
